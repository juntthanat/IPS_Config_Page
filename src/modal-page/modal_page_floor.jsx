...
export default function modalPageFloor(selectedFloor, buttonType) {
  return (
    <div id="modal-page-floor-main">
      <div className="modal-page-container">
        <div className="floor-id-header">{buttonType === "create" ? ("FLOOR ID AUTOGENERATED") : ("FLOOR ID " + selectedFloor)}</div>
